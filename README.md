...
- `YANDEX_API_KEY` — ключ от API Яндекса (JavaScript API и HTTP Геокодер). [Как подключить](https://dvmn.org/encyclopedia/api-docs/yandex-geocoder-api/). [Где брать ключ](https://developer.tech.yandex.ru/services)
